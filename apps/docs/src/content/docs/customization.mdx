	...
	properties={[
		{
			...
			defaultValue: '325px',
			purpose: 'Minimum inline size of the document body.',
		},
		{
			property: 'body-max-width',
			defaultValue: '100dvw',
			purpose: 'Maximum inline size of the document body.',
		},
		{
			property: 'body-min-height',
			defaultValue: '100%',
			purpose: 'Minimum block size applied to the html and body elements.',
		},
		{
