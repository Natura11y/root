...
The <LinkOpenNew LinkUrl="https://natura11y.github.io/core/dist/html/templates/search-results/" LinkText="Search Results Template" /> demonstrates this pattern in a full page layout, including a refined search field, filter sidebar, results list, and pagination.
