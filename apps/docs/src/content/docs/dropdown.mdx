...
The `aria-controls` attribute should reference the ID of the associated dropdown menu. Because the button has no visible text, its `aria-label` should describe the menu it opens.
