...
output: adoption-plan/plans/<date>-adoption-plan.md
---
...
Write `plans/<date>-adoption-plan.md` from `templates/adoption-plan.md`. Close the session by presenting wave 1 as "Monday morning": the concrete first items, their mapping rows, and the done-when.
