...
Before the teardown, check the vehicle in. This step builds `adoption-plan/GARAGE.md`: a profile of the product, the target design system, and a map of what evidence the agent can actually reach. Every phase reads this file first.
...
_Checked in: <date> · Method: adoption-plan · Technician: <agent + catalog access>_
...
- `plans/<date>-adoption-plan.md` — phase 4 build schedule
```
