...
- Run the companion **`/adoption-plan`** skill — it turns exactly this station's findings into a full restoration estimate: teardown, verified pattern → component mappings, effort grades, and a phased build schedule.
